...
def main():
	...
	parser.add_argument('--id', type=int, metavar='experiment_id',
	                    help='Experiment ID')
	parser.add_argument('--qw', type=int, help='Quantization parameter for weights')
	parser.add_argument('--qa', type=int, help='Quantization parameter for activations')
	...
	experiment = ExperimentDesign(generator, option, args)
	experiment.run()
